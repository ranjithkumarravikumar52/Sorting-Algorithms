...
public class RadixSort extends FixedDataRangeSortAlgorithm {
    ...
    public RadixSort() {
        ...
        this.setInputArray(unSortedArray);
    }
     ...
     * MUST use stable sort algorithm. WHY? Think about it. HINT: Sorting is done based on each digit/character
     */
    ...
    public int[] sort(int[] inputArray) {
        return radixSortIntegers(inputArray);
    }
}
